...
-(void)initsubView
{
    if ( _bgView == nil )
    {
        ...
        _bgView.frame = CGRectMake(0, Main_Screen_Height, Main_Screen_Width, 161.0f)
        ;
    ...
    CGRect rect = CGRectMake(0, 0.0f, Main_Screen_Width, 50.0f);
    if ( _firstBtn == nil )
    {
        _firstBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        [_firstBtn setTitle:@"从相册获取" forState:UIControlStateNormal];
    ...
    if ( _nextBtn == nil )
    {
        ...
        [_nextBtn setTitle:@"拍照" forState:UIControlStateNormal];
    ...
    if ( _canBtn == nil )
    {
        ...
        [_canBtn setTitle:@"取消" forState:UIControlStateNormal];
...
-(void)showView
{
    [UIView animateWithDuration:0.3f animations:^
     {
         _bgView.frame = CGRectMake(0, Main_Screen_Height-161.0f, Main_Screen_Width, 161.0f);
