...
+ (void)copyInstance:(MKBaseObject *)one toAnotherInstance:(MKBaseObject *)two
{
    if (self == [MKBaseObject class])
    {
        return;
    }
...
- (id)decodeNSDictionaryValue:(id)value withProperty:(NSString *)propertyName andTypeName:(NSString *)typeName;
{
    ...
    if ([c isSubclassOfClass:[MKBaseObject class]])
    {
        MKBaseObject *instance = [c objectWithDictionary:value];
        return instance;
    }
    return value;
}
...
- (NSArray *)decodeArrayValue:(id)value withProperty:(NSString *)propertyName
{
    ...
    for (NSDictionary *d in value)
    {
        ...
        MKBaseObject *instance = [c objectWithDictionary:d];
...
+ (id)encodeInstance:(id)instance
{
    ...
    if ([instance isKindOfClass:[NSArray class]])
    {
        ...
        {
            id oo;
            if ([o isKindOfClass:[MKBaseObject class]])
            {
    ...
    if ([instance isKindOfClass:[NSDictionary class]])
    {
        ...
        [instance enumerateKeysAndObjectsUsingBlock:^(id key, id obj, BOOL *stop)
         {
             id oo;
             if ([obj isKindOfClass:[MKBaseObject class]])
             {
    ...
    if (![instance isKindOfClass:[MKBaseObject class]])
    {
        return nil;
    }
    ...
    for (OCPropertyInfo *p in properties)
    {
        ...
        id oo;
        if ([v isKindOfClass:[MKBaseObject class]])
        {
...
@implementation MKBaseObject (save)

#define defaultSavePath @"MKObjects/"

- (BOOL)saveToClassFile
{
    NSString *f = NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES)[0];
