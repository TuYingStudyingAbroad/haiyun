...
- (id)initWithTitle:(NSString *)title image:(UIImage *)image message:(NSString *)message message1:(NSString *)message1 {
    self = [super init];
    if (self) {
        _title = title;
        _image = image;
...
- (void)viewDidLoad {
    ...
    _photo1 = [[UIImageView alloc] initWithFrame:CGRectZero];
    _photo1.translatesAutoresizingMaskIntoConstraints = false;
    _photo1.layer.cornerRadius = 2;
    _photo1.layer.masksToBounds = true;
    _photo1.image = _image;
    [_backView addSubview:_photo1];
    
    
    
    _messageLbl = [[UILabel alloc] initWithFrame:CGRectZero];
    _messageLbl.translatesAutoresizingMaskIntoConstraints = false;
    _messageLbl.textColor = [UIColor colorWithHexString:@"333333"];
    _messageLbl.font = [UIFont systemFontOfSize:16];
    _messageLbl.text = _message;
    [_backView addSubview:_messageLbl];
    
    _messageLbl1 = [[UILabel alloc] initWithFrame:CGRectZero];
    _messageLbl1.translatesAutoresizingMaskIntoConstraints = false;
    _messageLbl1.textColor = [UIColor colorWithHexString:@"333333"];
    _messageLbl1.font = [UIFont systemFontOfSize:16];
    _messageLbl1.text = _message1;
   
    [_backView addSubview:_messageLbl1];
    
    

    
    
    UIColor *lineColor = [UIColor colorWithHexString:@"e3e1e4"];
    ...
    [_cancel setTitleColor:[UIColor colorWithHexString:@"999999"] forState:UIControlStateNormal];
    ...
    [_send setTitleColor:[UIColor colorWithHexString:@"252525"] forState:UIControlStateNormal];
    ...
    NSDictionary *views = NSDictionaryOfVariableBindings(_backView, _titleLbl, _photo, _messageLbl,_photo1, _messageLbl1, _hLine, _vLine, _cancel, _send);
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-12-[_titleLbl]-12-[_photo(18)]-12-[_photo1(18)]-12-[_hLine(one)][_cancel(44)]|" options:0 metrics:met views:views]];
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|-60-[_photo(18)]-10-[_messageLbl]-10-|" options:0 metrics:nil views:views]];
    
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|-60-[_photo1(18)]-10-[_messageLbl1]-10-|" options:0 metrics:nil views:views]];
    ...
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:_messageLbl1 attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:_photo1 attribute:NSLayoutAttributeCenterY multiplier:1 constant:0]];
