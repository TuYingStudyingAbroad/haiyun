...
- (void)updateWithEntryObject:(MKMarketingComponentObject *)object
{
    ...
    [self.singleLineView updateVerticalViews:a withSeperator:itemInformation.needBorder isLeft:YES];
