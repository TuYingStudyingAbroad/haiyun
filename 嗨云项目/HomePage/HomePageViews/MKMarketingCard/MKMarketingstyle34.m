...
- (void)updateWithEntryObject:(MKMarketingComponentObject *)object
{
    ...
    [self.singleLineView updateStyle3Views:a withSeperator:itemInformation.needBorder isLeft:YES];
...
+(CGFloat)cellHeight
{
    return 2.0 * [UIScreen mainScreen].bounds.size.width/3.0;
}
