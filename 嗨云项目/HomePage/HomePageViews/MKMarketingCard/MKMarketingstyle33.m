...
- (void)updateWithEntryObject:(MKMarketingComponentObject *)object
{
    ...
    [self.singleLineView updateStyle3Views:a withSeperator:itemInformation.needBorder isLeft:NO];
