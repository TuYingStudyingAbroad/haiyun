...
- (void)updateWithEntryObject:(MKMarketingComponentObject *)object
{
    ...
    [self.singleLineView updatHorizationaleViews:a withSeperator:itemInformation.needBorder isLeft:YES];
